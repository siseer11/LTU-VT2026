...
const actors: Prisma.ActorCreateInput[] = [
  ...
  {
    name: "Alain Chabat",
    character: "Alice's Father (voice)",
  ...
  {
    name: "Marlon Wayans",
    character: "Shorty / 'Joe' / 'Tiffany' / Count Brolock",
  ...
  {
    name: "Dave Sheridan",
    character: "Doofy / Ghostface (voice)",
  ...
  {
    name: "Keith David",
    character: "Narrator of Spider Video (voice)",
  ...
  },
  {
    ...
    character: "Herman Schultz / Shocker #2",
  ...
  },
  {
    ...
    character: "Jeannette Christiansen",
  ...
  },
  {
    ...
    character: "Purple Sklarian Raider",
  ...
  for (const movie of movies) {
    ...
    await prisma.movie.create({
      data: {
        ...
        actors: {
          connect: randomActors.map((actor) => ({
            id: actor.id,
          })),
        },
      },
